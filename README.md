...
```mermaid
flowchart LR
    A[Landing and onboarding] --> B[Dashboard]
    B --> C[Projects]
    B --> D[Team]
    B --> E[Knowledge]
    B --> F[AI Lab]
    B --> G[Settings]
    C --> H[Structured project intake]
    F --> I[Agent-assisted planning and execution support]
```
...
<table>
  <tr>
    <td width="100%" valign="top">
      <img src="assets/screenshots/nerdprm-home.png" alt="nerdPRM landing surface" width="100%" />
      <br />
